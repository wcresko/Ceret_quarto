# Alizarin Staining {#sec-molec_aliz}
...
::: {.callout-note title="Note"}
Check for the strenght of staining often. I prefer to slightly over stain as slight non-specific (muscles and etc) will clear in the following steps.
::  
